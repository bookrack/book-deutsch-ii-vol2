     ...
     exercise: [
       {
          ...
          data: [
            ...
            },
            {
              ...
              image: {
                src: '31-bruder-text.png'
              },
              sourceAnchors: ["RightMiddle"],
              targetAnchors: []
            },
            {
              identifier: 'vater-text',
              style: {
                top: '65%',
                left: '10%',
                width: '20%',
            ...
            },
            {
              ...
              image: {
                src: '31-schwester.png'
              },
              solution: 'schwester-text',
              solutionImg: {
                src: '31-schwester.png'
              },
              sourceAnchors: [],
      ...
      exercise: [
        {
          ...
          help: {
            toggle: false,
            text: 'Priveste imaginile si raspunde. Cand ai terminat apasa pe cheita si verifica. Succes!'
          },
          data: [
            {
              identifier: 'one',
     ...
     exercise: [
       {
          ...
          help: {
            toggle: false,
            text: 'Uneste textul cu imaginile potrivite. Cand ai terminat apasa pe cheita si verifica. Succes!'
          },
          data: [
            {
              identifier: 'cantina',
    ...
    '68': {
      exercise: [
        ...
        },
        {
          ...
          help: {
            toggle: false,
            text: 'Citeste si uneste! Cand ai terminat apasa pe cheita si verifica. Succes!'
          },
          data: [
            {
              identifier: '1',
